...
new_logo = r'''def titan_logo_text(open_eyes=True):
    ...
    # Tiny Titan body, same big eyes.
    # Short yellow, tall orange, short coral.
    ...
    # eye row: body is smaller, eyes stay large
    seg("     ")
    seg("    ", yellow)
...
print("Patched header mascot: even smaller body, oversized cute eyes.")
